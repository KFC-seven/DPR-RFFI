...
def main() -> int:
    ...
    parser.add_argument(
        ...
        choices=["head", "random"],
        default="head",
        help="Per-record sampling rule; paper runs use random for ManySig and head for ManyTx.",
    )
    ...
    # DPRRFFI performs RMS normalization before perturbation. These callbacks
    # therefore preserve the perturbed gain instead of normalizing it away.
